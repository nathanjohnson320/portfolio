...
import logoSprout from '@/images/logos/sprout.png'
import logoPassport from '@/images/logos/passport.png'
import logoStord from '@/images/logos/stord.png'
import logoRedVentures from '@/images/logos/red-ventures.png'
...
function Resume() {
  ...
  return (
    <div className="rounded-2xl border border-zinc-100 p-6 dark:border-zinc-700/40">
      ...
      <Button
        href="/files/nathan-johnson-resume.pdf"
        variant="secondary"
